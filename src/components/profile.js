    ...
    <div id="profile" className="profile-section">
      ...
      {isExpanded && (
        <div className="content">
          ...
          <h3>💼 다양한 업무 경험</h3>
          <p>
            호텔, 레스토랑 등의 다양한 요식업, 서비스업 분야에서 일하며 다양한 현장에서 책임감을 배우고 성실함을 다졌습니다. 한국으로 돌아와서는 울릉도에서 공군 운전병으로 복무하며 그 생활을 마쳤고, 이후에는 진로 탐색 과정에서 기업들에서 모바일 방송 송출, 해외 마케팅 및 통역과 계약 지원, 그리고 학원에서 성인 대상 공인 영어 시험 및 회화 강의를 진행하며 다채로운 업무 경험을 쌓았습니다.
          </p>
