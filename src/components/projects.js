...
const projects = [
  ...
  // { title: 'Capstone Design Project - 2024', description: 'Capstone Design Project - 2024', link: '' },
  // { title: 'Software Project - 2024', description: 'Software Project - 2024', link: '' },
  // { title: 'Software Project - 2023', description: 'Software Project - 2023', link: '' },
  // { title: '스프링 프로젝트 - 2023', description: '학교 게시판 만들기', link: '' },
  // { title: 'JSP 프로젝트 - 2022', description: 'Red Devils', link: '' },
